...
import dishImage from "../Image/dish.png"; // Your uploaded image
...
export default function Homechallenge() {
  ...
  return (
    <div className="fun-zone-container">
      <h1 className="title">🎉 Welcome to the Fun Zone! 🎉</h1>

      <div className="spin-wheel">
        <img src={dishImage} alt="Spin Wheel" className="wheel-image" />
      </div>

      <button className="spin-button">🎡 Spin the Wheel!</button>
